        ...
        if is_fortnite_running():
            if not esc_blocked:
                ...
                tray_icon.showMessage(
                    "ESC Blocker",
                    "ESC zablokowany (Fortnite aktywny)",
                    QSystemTrayIcon.Information, 3000)
                tray_icon.setToolTip("ESC Blocker: ESC zablokowany – Fortnite aktywny")
        else:
            if esc_blocked:
                unblock_esc()
                esc_blocked = False
                tray_icon.showMessage(
                    "ESC Blocker",
                    "ESC odblokowany (Fortnite nieaktywny)",
                    QSystemTrayIcon.Information, 3000)
                tray_icon.setToolTip("ESC Blocker: ESC odblokowany – Fortnite nieaktywny")
        time.sleep(2)
...
if __name__ == "__main__":
    ...
    tray_icon.setToolTip("ESC Blocker: Oczekiwanie na Fortnite")
    tray_icon.show()
